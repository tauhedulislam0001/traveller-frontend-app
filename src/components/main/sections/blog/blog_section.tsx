  ...
  const [isMounted, setIsMounted] = useState(false);
    ...
    return (
        <div className="container mx-auto px-4 relative md:mt-24 mt-16">
            ...
            {data?.data.map((blog) => (
                <div key={blog.id} className="group bg-white dark:bg-slate-800 rounded-xl shadow-lg dark:shadow-gray-800 overflow-hidden hover:shadow-xl dark:hover:shadow-gray-700 transition-all duration-300">
                <div className="relative overflow-hidden">
                    ...
                    <span className="bg-custom-red text-white text-xs px-3 py-1.5 font-semibold rounded-full">
                        {blog.category_name}
                    </span>
                    </div>
                </div>
                ...
                <div className="p-6">
                    ...
                    <a href="#" className="text-xl font-bold text-slate-900 dark:text-white hover:text-custom-red duration-300 block mb-3">
                    {blog.title}
                    </a>
