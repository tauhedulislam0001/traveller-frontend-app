...
interface BillingProps {
  billingAddress: BillingAddress; // Changed from array to single object
  onEdit?: () => void; // Optional edit handler
}

function Billing({ billingAddress, onEdit }: BillingProps) {
  return (
    <div className="p-5 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/50">
      <div className="flex items-center mb-4 justify-between">
        <h5 className="text-xl font-bold text-gray-800 dark:text-white">Billing Address:</h5>
        <button 
          onClick={onEdit}
      ...
      <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
        <p className="text-lg font-semibold text-gray-800 dark:text-white mb-3">{billingAddress.name}</p>
        ...
        <ul className="list-none space-y-3">
          <li className="flex items-start">
            ...
            <p className="text-gray-600 dark:text-gray-300">{billingAddress.address}</p>
          </li>
          ...
          <li className="flex items-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">{billingAddress.phone}</p>
          </li>
          ...
          <li className="flex items-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">{billingAddress.email}</p>
          </li>
        </ul>
      </div>
    </div>
