...
const ShippingAddress: React.FC<ShippingAddressProps> = ({ customer }) => {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6">
      <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Shipping Address</h3>
      <div className="space-y-3">
        ...
        <div>
          ...
          <p className="text-gray-900 dark:text-white mt-1">{customer?.shipping_address || 'No shipping address added'}</p>
        </div>
        <div>
