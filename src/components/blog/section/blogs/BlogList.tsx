...
const BlogList: React.FC<{ data?: BlogResponse }> = ({ data }) => {
    ...
    useEffect(() => {
        console.log("Blog data loaded:", data);   // You can handle side effects here if needed
    });
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-10 gap-8">
                ...
                <div key={blog.id} className="group bg-white dark:bg-slate-800 rounded-xl shadow-lg dark:shadow-gray-800 overflow-hidden hover:shadow-xl dark:hover:shadow-gray-700 transition-all duration-300 border border-gray-200 dark:border-slate-700">
                    ...
                    <div className="p-6">
                        ...
                        <a href="#" className="inline-flex items-center font-semibold hover:text-[#fb2c36] transition-colors duration-300" style={{ color: themeColor }}>
                            Read More
