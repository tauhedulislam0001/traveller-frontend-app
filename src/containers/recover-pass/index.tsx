              ...
              {isSubmitted ? (
                ...
                <div>
                  <div className="my-6 text-center">
                    ...
                    <h5 className="text-xl font-semibold mb-2">Check Your Email</h5>
                    <p className="text-slate-400 mb-6">
                      We have sent a password reset link to <span className="text-red-500 font-semibold">{email}</span>. 
                    ...
                    <div className="text-center">
                      <Link 
                        href="/login" 
                        className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 hover:bg-red-600 text-white rounded-md font-medium"
                      >
                        Back to Login
                      </Link>
                    </div>
                    ...
                    <form className="text-start" onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1">
                        ...
                        <div className="mb-4">
                          <input 
                            type="submit" 
                            className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 hover:bg-red-600 text-white rounded-md w-full cursor-pointer" 
                            value="Send"
                          />
                        </div>
