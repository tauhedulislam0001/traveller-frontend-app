                ...
                <div className="grid grid-cols-1">
                  ...
                  <div className="flex justify-between mb-4">
                    ...
                    <p className="text-red-500 mb-0">
                      <Link href="/forgot-password" className="text-red-500">Forgot password ?</Link>
                    </p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <Link href="/signup" className="text-slate-900 dark:text-white font-bold inline-block">Sign Up</Link>
                  </div>
                </div>
              </form>
            </div>
